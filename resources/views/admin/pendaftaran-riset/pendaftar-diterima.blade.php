          ...
          <div class="col-12">
            <div class="card" style="margin-top: 1rem;">
              <div class="card-header">
                <h3 class="card-title">Data Pendaftar Kolaborasi Riset Diterima</h3>
              </div>
              <!-- /.card-header -->

              <div class="card-body">
                <div class="mb-3 d-flex justify-content-between">
                  <form action="{{ route('admin_daftar-riset.risetDiterima') }}" method="GET" class="form-inline">
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="d-flex align-items-center justify-content-center" style="gap: 10px;">
                              <a href="{{ route('admin_daftar-riset.edit-diterima', $item->id) }}"
