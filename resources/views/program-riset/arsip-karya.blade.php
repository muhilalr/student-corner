<x-layout-web>
  <div class="py-8 mx-auto px-6 lg:px-8">
    ...
    <div class="bg-white rounded-xl shadow-lg p-6 mb-8">
      <h1 class="text-center text-3xl font-bold text-gray-900">Arsip Karya Kolaborasi Riset Mandiri</h1>
    </div>

    <!-- Filter dan Search -->
    <div class="bg-white rounded-xl shadow-lg p-6 mb-8">
      <form method="GET" action="{{ route('program-riset.arsipKarya') }}">
