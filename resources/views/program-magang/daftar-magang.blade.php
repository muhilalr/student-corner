              ...
              <form action="{{ route('daftar-magang.upload-laporan', $pendaftaran->id) }}" method="POST"
                ...
                <div class="mb-4">
                  <div class="flex mb-2">
                    ...
                    <x-input-label for="laporan_magang" class="text-white text-left text-xs" :value="__('Upload Laporan Magang (PDF) * (Jika Anda telah selesai melaksanakan magang)')" />
                  </div>
                  <x-text-input id="laporan_magang"
