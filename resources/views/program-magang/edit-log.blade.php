      ...
      <div class="grid md:grid-cols-2 gap-6 px-6 mb-6">
        ...
        <div>
          ...
          <select name="status_kehadiran" id="status_kehadiran"
            ...
            <option value="hadir" {{ $log->status_kehadiran == 'hadir' ? 'selected' : '' }}>Hadir
            </option>
            <option value="sakit" {{ $log->status_kehadiran == 'sakit' ? 'selected' : '' }}>Sakit
            </option>
            <option value="izin" {{ $log->status_kehadiran == 'izin' ? 'selected' : '' }}>Izin
            </option>
          </select>
