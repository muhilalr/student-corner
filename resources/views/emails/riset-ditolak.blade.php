...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p>Terima kasih atas minat Anda untuk bergabung dengan program kolaborasi riset kami.</p>

      <div class="highlight">
        <p>Setelah melalui proses seleksi yang ketat, kami dengan berat hati harus menginformasikan bahwa aplikasi
          kolaborasi riset Anda <strong>belum dapat kami terima</strong> pada periode ini.</p>
      </div>
